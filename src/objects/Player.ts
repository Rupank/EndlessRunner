...
export default class Player extends GameObject {
    ...
    constructor(gameDispatcher: GameDispatcher) {
        ...
        // this.phaserGame.add.tween(this.sprite).to({ y: this.sprite.y - 10 }, 400, Phaser.Easing.Back.In, true, 0, -1, true);
    ...
    public update(): void {
        ...
        this.phaserGame.physics.arcade.collide(this.sprite, this.gameDispatcher.gameVars.pipeGroup, this.collide, null, this);

        // if (this.alive) {
        //     // coliision with enemies
        //     this.phaserGame.physics.arcade.overlap(this.sprite, this.gameDispatcher.gameVars.pipeGroup, this.pipeOverlap, null, this);
     ...
     */
    private pipeOverlap(playerSprite: Phaser.Sprite, enemy: Phaser.Sprite) {
        // this.kill();
        // this.gameDispatcher.soundService.play('die');
        // this.killTimer = this.phaserGame.time.events.add(Phaser.Timer.SECOND * 4, () => {
        //     this.reset();
